...
<body>
                    ...
                    <div class="gmap-sidebar" id="gmapSidebar">
                        ...
                        <div class="sidebar-section">
                            ...
                            <div class="autocomplete-wrapper">
                                <input type="text" id="gmapTownInput" class="gmap-input" placeholder="Start typing town name...">
                        ...
                        <div class="sidebar-section">
                            ...
                            <div class="address-input-wrapper">
                                <input type="text" id="gmapAddressLookup" class="gmap-input" placeholder="123 Main St, Putnam CT">
    ...
    (function() {
        ...
        document.getElementById('gmapGoProfileBtn').addEventListener('click', function() {
            ...
            // Save location data to localStorage for profile.php to read
            const locationData = {
                state_code: gmapLocationData.state_code,
                town_name: gmapLocationData.town_name,
                zip_code: gmapLocationData.zip_code || '',
                latitude: gmapLocationData.latitude,
                longitude: gmapLocationData.longitude,
                street_address: gmapLocationData.address || '',
            ...
            localStorage.setItem('tpb_location', JSON.stringify(locationData));
        ...
        // PAGE VISIT + INIT
        // =====================================================
        logCivicAction('page_visit', 'index2', { referrer: document.referrer || 'direct' });
