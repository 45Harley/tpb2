...
CREATE TABLE IF NOT EXISTS roll_call_votes (
    ...
    r_yea SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    r_nay SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    d_yea SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    d_nay SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    i_yea SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    i_nay SMALLINT UNSIGNED NOT NULL DEFAULT 0,
