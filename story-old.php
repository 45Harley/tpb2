...
?>
            ...
            <div class="cta-buttons">
                <a href="https://tpb2.sandgems.net/index.php" class="btn btn-primary" data-cta="platform" onclick="this.innerHTML='✓ Try The Platform'; this.classList.add('btn-clicked'); localStorage.setItem('tpb_cta_platform','1');">Try The Platform</a>
            </div>
    ...
    <footer>
        ...
        <p>
            <a href="/index.php">Platform Demo</a> | 
