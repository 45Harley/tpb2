 ...
 * Usage: /usa/                     (digest — default landing)
 *        /usa/?state=VT           (state delegation view)
 *        /usa/?rep=441            (rep detail view)
 *        /usa/?vote=123           (vote detail)
 *        /usa/?bill=hr-144        (bill detail)
 *        /usa/?committee=1049     (committee detail)
 *        /usa/?nom=650            (nomination detail)
 */
...
pageHead($shortName);
$crumbs = [['label' => 'Digest', 'url' => '?'], ['label' => 'Committees', 'url' => '#']];
...
<div class="breadcrumb" style="padding:12px 32px;background:#0d1220;border-bottom:1px solid var(--border);font-size:13px">
  <a href="?" style="color:var(--muted)">Digest</a>
...
pageHead("Congressional Digest — {$congress}th Congress");
?>
...
<div class="data-footer">
  <a href="?">&larr; Congressional Digest</a> &middot;
