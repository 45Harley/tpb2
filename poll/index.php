...
<?php include __DIR__ . '/../includes/nav.php'; ?>
    ...
    <main class="polls-container">
        ...
        <!-- Intro explainer -->
        <div class="intro-box">
            <p>Every executive action scoring <strong>300 or higher</strong> on the <a href="/usa/executive/" style="color:#d4af37">criminality scale</a> becomes a poll question here. These are documented threats to constitutional order &mdash; court orders defied, civil rights violated, public institutions dismantled. Note how low the bar is for impeachment: the Constitution requires only &ldquo;High Crimes and Misdemeanors&rdquo; &mdash; that&rsquo;s a <strong>301</strong> on this scale.</p>
