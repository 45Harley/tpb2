...
<?php include __DIR__ . '/../includes/nav.php'; ?>
    ...
    <main class="polls-container">
        ...
        <!-- Gemini Criminality Scale Visualizer -->
        <?php
        $zones = [
        ...
        ?>
        <style>
            .civic-scale-container { background: #0a0a0f; padding: 1.5rem; border-radius: 8px; border: 1px solid #333; margin-bottom: 2rem; }
        ...
        <div class="civic-scale-container">
