...
(function() {
    ...
    // ----- DOM refs -----
    var widget = document.getElementById('cWidget');
    var bubble = document.getElementById('cBubble');
    var panel = document.getElementById('cPanel');
    var overlay = document.getElementById('cModeOverlay');
    var messagesEl = document.getElementById('cMessages');
    var typingEl = document.getElementById('cTyping');
    var textInput = document.getElementById('cTextInput');
    var sendBtn = document.getElementById('cSendBtn');
    var micBtn = document.getElementById('cMicBtn');
    var minimizeBtn = document.getElementById('cMinimizeBtn');
    var settingsBtn = document.getElementById('cSettingsBtn');
    var settingsMenu = document.getElementById('cSettingsMenu');
    var modeDismiss = document.getElementById('cModeDismiss');
    ...
    function liveRespond(userMessage) {
        ...
        fetch('api/claude-chat.php', {
            ...
            body: JSON.stringify({
                ...
                user_id: (window.tpbPageState && window.tpbPageState.USER) ? window.tpbPageState.USER.userId : null,
    ...
    function handleUserInput(text) {
        ...
        if (isOffScript(text, flowState.step)) {
            ...
            // On-script: handle confirmation flow
    ...
    var modeButtons = overlay.querySelectorAll('.c-mode-btn');
    ...
    var settingsItems = settingsMenu.querySelectorAll('.c-settings-item');
    ...
    (function() {
        ...
        function startDrag(e) {
            ...
            if (e.target.closest('.c-header-btn') || e.target.closest('.c-settings-menu')) return;
    ...
    function init() {
        ...
        var user = (window.tpbPageState && window.tpbPageState.USER) ? window.tpbPageState.USER : null;
